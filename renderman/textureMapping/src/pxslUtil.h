...
void pxslSRGB(output color result) {
#define srgbA 0.07739938
#define srgbB 0.947867299
    //uniform float srgbA = 1./12.92;
    //uniform float srgbB = 1./1.055;
    result[0] = result[0] < .04045 ?
        result[0] * srgbA : pow((result[0]+.055) * srgbB , 2.4);
    result[1] = result[1] < .04045 ?
        result[1] * srgbA : pow((result[1]+.055) * srgbB , 2.4);
    result[2] = result[2] < .04045 ?
        result[2] * srgbA : pow((result[2]+.055) * srgbB , 2.4);
}
